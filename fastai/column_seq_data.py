...
class ColumnarSeqModelData(ModelData):
    ...
    @classmethod
    def from_data_frames(cls, path, trn_seqs_lim, trn_df, trn_y, val_seqs_lim, val_df, val_y, cat_flds, bs=1, is_reg=True, is_multi=False, test_seqs_lim=None, test_df=None, shuffle=True):
        ...
        test_ds = ColumnarSeqDataset.from_data_frame(test_seqs_lim, test_df, cat_flds, None,  is_reg, is_multi) if test_df is not None else None
